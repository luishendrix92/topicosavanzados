...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27154__auto__,writer__27155__auto__,opt__27156__auto__){
return cljs.core._write.call(null,writer__27155__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__29985 = o;
(G__29985[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__29986__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__29986 = function (var_args){
var args = null;
...
return G__29986__delegate.call(this,args);};
G__29986.cljs$lang$maxFixedArity = 0;
G__29986.cljs$lang$applyTo = (function (arglist__29988){
var args = cljs.core.seq(arglist__29988);
return G__29986__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__26536__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26536__auto__){
var and__26536__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__29993 = jsprops;
(G__29993["defaultValue"] = value);

(G__29993["onChange"] = ((function (G__29993,v,value,on_change){
return (function (p1__29991_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29991_SHARP_);
});})(G__29993,v,value,on_change))
);
...
var vec__30000 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30000,(0),null);
var id = cljs.core.nth.call(null,vec__30000,(1),null);
var class$ = cljs.core.nth.call(null,vec__30000,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30005 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30005 == null)){
} else {
var key_30006 = temp__4661__auto___30005;
(jsprops["key"] = key_30006);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30008 = (new reagent.impl.template.NativeWrapper());
(G__30008["name"] = c);
...
var len__27623__auto___30014 = arguments.length;
var i__27624__auto___30015 = (0);
while(true){
if((i__27624__auto___30015 < len__27623__auto___30014)){
args__27630__auto__.push((arguments[i__27624__auto___30015]));

var G__30016 = (i__27624__auto___30015 + (1));
i__27624__auto___30015 = G__30016;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27631__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30012){
var G__30013 = cljs.core.first.call(null,seq30012);
var seq30012__$1 = cljs.core.next.call(null,seq30012);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30013,seq30012__$1);
});
...
break;
default:
var G__30020 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30020;
continue;
...
var n__27463__auto___30023 = a.length;
var i_30024 = (0);
while(true){
if((i_30024 < n__27463__auto___30023)){
(a[i_30024] = reagent.impl.template.as_element.call(null,(a[i_30024])));
...
var a = cljs.core.into_array.call(null,s);
var n__27463__auto___30026 = a.length;
var i_30027 = (0);
while(true){
if((i_30027 < n__27463__auto___30026)){
var val_30028 = (a[i_30027]);
if((cljs.core.vector_QMARK_.call(null,val_30028)) && ((reagent.impl.template.key_from_vec.call(null,val_30028) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30027] = reagent.impl.template.as_element.call(null,val_30028));

var G__30029 = (i_30027 + (1));
i_30027 = G__30029;
continue;
} else {
}
...
var ctx = ({});
var vec__30033 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30033,(0),null);
var derefed = cljs.core.nth.call(null,vec__30033,(1),null);
...
var G__30037 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30037) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30037){
