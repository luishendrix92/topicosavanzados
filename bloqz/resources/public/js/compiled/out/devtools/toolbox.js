...
var args40842 = [];
var len__27623__auto___40848 = arguments.length;
var i__27624__auto___40849 = (0);
while(true){
if((i__27624__auto___40849 < len__27623__auto___40848)){
args40842.push((arguments[i__27624__auto___40849]));

var G__40850 = (i__27624__auto___40849 + (1));
i__27624__auto___40849 = G__40850;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args40842.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox40845 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40845 = (function (obj,header,style,tag,meta40846){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40845.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40847,meta40846__$1){
var self__ = this;
var _40847__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40845(self__.obj,self__.header,self__.style,self__.tag,meta40846__$1));
});

devtools.toolbox.t_devtools$toolbox40845.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40847){
var self__ = this;
var _40847__$1 = this;
return self__.meta40846;
});

devtools.toolbox.t_devtools$toolbox40845.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox40845.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40845.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40845.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40845.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40846","meta40846",1979741167,null)], null);
});

devtools.toolbox.t_devtools$toolbox40845.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40845.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40845";

devtools.toolbox.t_devtools$toolbox40845.cljs$lang$ctorPrWriter = (function (this__27154__auto__,writer__27155__auto__,opt__27156__auto__){
return cljs.core._write.call(null,writer__27155__auto__,"devtools.toolbox/t_devtools$toolbox40845");
});

devtools.toolbox.__GT_t_devtools$toolbox40845 = (function devtools$toolbox$__GT_t_devtools$toolbox40845(obj__$1,header__$1,style__$1,tag__$1,meta40846){
return (new devtools.toolbox.t_devtools$toolbox40845(obj__$1,header__$1,style__$1,tag__$1,meta40846));
});

}

return (new devtools.toolbox.t_devtools$toolbox40845(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1496160797443