...
var len__27623__auto___40351 = arguments.length;
var i__27624__auto___40352 = (0);
while(true){
if((i__27624__auto___40352 < len__27623__auto___40351)){
args__27630__auto__.push((arguments[i__27624__auto___40352]));

var G__40353 = (i__27624__auto___40352 + (1));
i__27624__auto___40352 = G__40353;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27631__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq40349){
var G__40350 = cljs.core.first.call(null,seq40349);
var seq40349__$1 = cljs.core.next.call(null,seq40349);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__40350,seq40349__$1);
});
...
return (p1__40354_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1496160796269