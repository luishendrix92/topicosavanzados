...
var len__27623__auto___40519 = arguments.length;
var i__27624__auto___40520 = (0);
while(true){
if((i__27624__auto___40520 < len__27623__auto___40519)){
args__27630__auto__.push((arguments[i__27624__auto___40520]));

var G__40521 = (i__27624__auto___40520 + (1));
i__27624__auto___40520 = G__40521;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27631__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40516){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40517,G__40518,seq40516__$2);
});
...
if(cljs.core.truth_((function (){var or__26548__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27154__auto__,writer__27155__auto__,opt__27156__auto__){
return cljs.core._write.call(null,writer__27155__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__26536__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__26536__auto__){
var or__26548__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40522_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__40522_SHARP_));
})))){
...
var map__40531 = opts;
var map__40531__$1 = ((((!((map__40531 == null)))?((((map__40531.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40531.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40531):map__40531);
var markup_db = cljs.core.get.call(null,map__40531__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__26548__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40535){var e__37722__auto__ = e40535;
return false;
}})();
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
...
}catch (e40537){var e__37722__auto__ = e40537;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40542 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40543 = opts;
...
var markup_db = cljs.core.get.call(null,map__40543__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40542;
}});
...
;
var temp__4655__auto___40548 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40548)){
var managed_print_level_40549 = temp__4655__auto___40548;
var _STAR_print_level_STAR_40547_40550 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40549;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40547_40550,managed_print_level_40549,temp__4655__auto___40548,writer,opts,job_fn){
return (function (p1__40545_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40545_SHARP_,null);
});})(_STAR_print_level_STAR_40547_40550,managed_print_level_40549,temp__4655__auto___40548,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40547_40550;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1496160796687