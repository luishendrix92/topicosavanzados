...
var and__26536__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__26536__auto__){
var or__26548__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e40813){var e__37722__auto__ = e40813;
return false;
...
}catch (e40815){var e__37722__auto__ = e40815;
return false;
...
}catch (e40821){var e__37722__auto__ = e40821;
return false;
...
}catch (e40823){var e__37722__auto__ = e40823;
return false;
...
}catch (e40829){var e__37722__auto__ = e40829;
return false;
}})())){
...
}catch (e40831){var e__37722__auto__ = e40831;
return false;
}})())){
...
var _STAR_current_state_STAR_40834 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__26548__auto__ = config;
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40834;
}});
});
...
while (G__40838__i < G__40838__a.length) {G__40838__a[G__40838__i] = arguments[G__40838__i + 0]; ++G__40838__i;}
  args = new cljs.core.IndexedSeq(G__40838__a,0);
} 
...
var pre_handler = (function (){var or__26548__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
var post_handler = (function (){var or__26548__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1496160797400