...
var temp__4657__auto____$1 = goog.object.get(o__37710__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37709__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37709__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__37697__auto__ = f;
return goog.object.get(o__37697__auto__,"toString").call(o__37697__auto__);
}catch (e40171){var _ = e40171;
return "";
}});
...
try{var o__37697__auto___40174 = t;
goog.object.get(o__37697__auto___40174,"cljs$lang$ctorPrWriter").call(o__37697__auto___40174,t,writer);
}catch (e40173){var __40175 = e40173;
}
...
var char_code = (function (){var o__37697__auto__ = (new String(char$));
return goog.object.get(o__37697__auto__,"charCodeAt").call(o__37697__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37697__auto__ = String;
return goog.object.get(o__37697__auto__,"fromCharCode").call(o__37697__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40177 = num_code;
switch (G__40177) {
case (1):
return (185);
...
var o__37697__auto__ = String;
return goog.object.get(o__37697__auto__,"fromCharCode").call(o__37697__auto__,superscript_code);
});
/**
...
}catch (e40183){var e__37722__auto__ = e40183;
return false;
}})())){
...
var vec__40184 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40184,(0),null);
...
var or__26548__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__37710__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__37710__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37709__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37709__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27623__auto___40193 = arguments.length;
var i__27624__auto___40194 = (0);
while(true){
if((i__27624__auto___40194 < len__27623__auto___40193)){
args__27630__auto__.push((arguments[i__27624__auto___40194]));

var G__40195 = (i__27624__auto___40194 + (1));
i__27624__auto___40194 = G__40195;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27631__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40189){
var vec__40190 = p__40189;
var ns_detector = cljs.core.nth.call(null,vec__40190,(0),null);
var effective_detector = (function (){var or__26548__auto__ = ns_detector;
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
var G__40196 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40197 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40196;
remaining_tokens = G__40197;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40187){
var G__40188 = cljs.core.first.call(null,seq40187);
var seq40187__$1 = cljs.core.next.call(null,seq40187);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40188,seq40187__$1);
});
...
var vec__40205 = cljs.core.split_with.call(null,(function (p1__40201_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40201_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40205,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40205,(1),null);
...
var vec__40211 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40211,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40211,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40214 = cljs.core.rest.call(null,remaining_tokens);
var G__40215 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40214;
name_tokens = G__40215;
continue;
} else {
...
var args40216 = [];
var len__27623__auto___40228 = arguments.length;
var i__27624__auto___40229 = (0);
while(true){
if((i__27624__auto___40229 < len__27623__auto___40228)){
args40216.push((arguments[i__27624__auto___40229]));

var G__40230 = (i__27624__auto___40229 + (1));
i__27624__auto___40229 = G__40230;
continue;
} else {
}
break;
...
var vec__40219 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40219,(0),null);
var arity = cljs.core.nth.call(null,vec__40219,(1),null);
var vec__40222 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40222,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40222,(1),null);
var vec__40225 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40225,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40225,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40225,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40225,(3),null);
...
var args40232 = [];
var len__27623__auto___40238 = arguments.length;
var i__27624__auto___40239 = (0);
while(true){
if((i__27624__auto___40239 < len__27623__auto___40238)){
args40232.push((arguments[i__27624__auto___40239]));

var G__40240 = (i__27624__auto___40239 + (1));
i__27624__auto___40239 = G__40240;
continue;
} else {
}
break;
...
var vec__40235 = result;
var munged_ns = cljs.core.nth.call(null,vec__40235,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40235,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40235,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40235,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40235,(4),null);
var arity = cljs.core.nth.call(null,vec__40235,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__40248 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__40248,(0),null);
var args = cljs.core.nth.call(null,vec__40248,(1),null);
var vec__40251 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40251,(0),null);
var name = cljs.core.nth.call(null,vec__40251,(1),null);
...
var G__40254 = (arity + (1));
var G__40255 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40256){
var vec__40260 = p__40256;
var arity = cljs.core.nth.call(null,vec__40260,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40260,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__26548__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__40263_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40264_SHARP_);
...
var args__27630__auto__ = [];
var len__27623__auto___40271 = arguments.length;
var i__27624__auto___40272 = (0);
while(true){
if((i__27624__auto___40272 < len__27623__auto___40271)){
args__27630__auto__.push((arguments[i__27624__auto___40272]));

var G__40273 = (i__27624__auto___40272 + (1));
i__27624__auto___40272 = G__40273;
continue;
} else {
}
break;
...
var argseq__27631__auto__ = ((((1) < args__27630__auto__.length))?(new cljs.core.IndexedSeq(args__27630__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27631__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40267){
var vec__40268 = p__40267;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40268,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40265){
var G__40266 = cljs.core.first.call(null,seq40265);
var seq40265__$1 = cljs.core.next.call(null,seq40265);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40266,seq40265__$1);
});
...
var G__40275 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__40275) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__26548__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__26536__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__26548__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__40282__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40282__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40282__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40282__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40283 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40283,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40283,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40283,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40283,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40283,(4),null);
var arity = cljs.core.nth.call(null,vec__40283,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__26536__auto__ = protocol_ns;
if(cljs.core.truth_(and__26536__auto__)){
return cljs.core.not.call(null,(function (){var and__26536__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__26548__auto__ = protocol_part;
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
return fn_part;
...
var o__37697__auto__ = f;
return goog.object.get(o__37697__auto__,"getBasis").call(o__37697__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__26536__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__26536__auto__)){
...
}catch (e40288){var e__37722__auto__ = e40288;
...
var G__40289 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__40290 = cljs.core.rest.call(null,path);
obj = G__40289;
path = G__40290;
continue;
} else {
...
var partition_bits = (function (){var or__26548__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__26548__auto__)){
return or__26548__auto__;
} else {
return (0);
...
return (function (accum,p__40295){
var vec__40296 = p__40295;
var bit = cljs.core.nth.call(null,vec__40296,(0),null);
var protocol = cljs.core.nth.call(null,vec__40296,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40299){
var vec__40303 = p__40299;
var ns = cljs.core.nth.call(null,vec__40303,(0),null);
var name = cljs.core.nth.call(null,vec__40303,(1),null);
var selector = cljs.core.nth.call(null,vec__40303,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__40312,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40312,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40312,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40306_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__40306_SHARP_));
});})(name,sorted_matches,vec__40312,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1496160796100