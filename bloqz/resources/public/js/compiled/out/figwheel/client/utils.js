...
var or__26548__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34017 = {"detail":data};
return obj34017;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26536__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26536__auto__)){
var and__26536__auto____$1 = (window["CustomEvent"]);
...
var args34022 = [];
var len__27623__auto___34028 = arguments.length;
var i__27624__auto___34029 = (0);
while(true){
if((i__27624__auto___34029 < len__27623__auto___34028)){
args34022.push((arguments[i__27624__auto___34029]));

var G__34030 = (i__27624__auto___34029 + (1));
i__27624__auto___34029 = G__34030;
continue;
} else {
}
break;
...
var f = (function (){var pred__34025 = cljs.core._EQ_;
var expr__34026 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34025.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34026))){
return ((function (pred__34025,expr__34026){
return (function (p1__34018_SHARP_){
return console.warn(p1__34018_SHARP_);
});
;})(pred__34025,expr__34026))
} else {
if(cljs.core.truth_(pred__34025.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34026))){
return ((function (pred__34025,expr__34026){
return (function (p1__34019_SHARP_){
return console.debug(p1__34019_SHARP_);
});
;})(pred__34025,expr__34026))
} else {
if(cljs.core.truth_(pred__34025.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34026))){
return ((function (pred__34025,expr__34026){
return (function (p1__34020_SHARP_){
return console.error(p1__34020_SHARP_);
});
;})(pred__34025,expr__34026))
} else {
return ((function (pred__34025,expr__34026){
return (function (p1__34021_SHARP_){
return console.log(p1__34021_SHARP_);
});
;})(pred__34025,expr__34026))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34032){
var map__34035 = p__34032;
var map__34035__$1 = ((((!((map__34035 == null)))?((((map__34035.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34035.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34035):map__34035);
var opts = map__34035__$1;
var eval_fn = cljs.core.get.call(null,map__34035__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34037_SHARP_);
});})(new_def))
);
...
return (function (p__34038){
var vec__34039 = p__34038;
var ky = cljs.core.nth.call(null,vec__34039,(0),null);
var v = cljs.core.nth.call(null,vec__34039,(1),null);
...
var args34042 = [];
var len__27623__auto___34045 = arguments.length;
var i__27624__auto___34046 = (0);
while(true){
if((i__27624__auto___34046 < len__27623__auto___34045)){
args34042.push((arguments[i__27624__auto___34046]));

var G__34047 = (i__27624__auto___34046 + (1));
i__27624__auto___34046 = G__34047;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__26536__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1496160786494